    ...
    private fun buildDialog() {
        ...
        builder.setCustomTitle(title)
            .setPositiveButton("Save") { dialog, _ ->
                ...
                val Professional=view.findViewById<RadioButton>(R.id.radioButton4)
                ...
                if(Hour==null||Minute==null|| DayOfMonth==null || Month==null || Year==null){
...
//        if(type=="Important"){
//             color = Color.parseColor("#FF6969")
//        }
//        if(type=="Personal"){
//             color = Color.parseColor("#ECF2FF")
//        }
//        if(type=="Professional"){
//             color = Color.parseColor("#B2A4FF")
//        }
//        if(type=="Party"){
//             color = Color.parseColor("#C7E9B0")
//        }
//        // red color
